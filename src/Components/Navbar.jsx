        ...
        >
            ...
            <div className="flex items-center justify-center gap-6">
                {[
                    {
                        icon: <FaLinkedin />,
                        href: "https://www.linkedin.com/in/shivam-upadhyay-824888246/",
                        color: "hover:text-blue-500"
                    },
                    {
                        icon: <FaGithub />,
                        href: "https://github.com/Shivamup51",
                        color: "hover:text-gray-400"
                    },
                    {
                        icon: <FaMailBulk />,
                        href: "mailto:shivamupadhyay2868@gmail.com",
                        color: "hover:text-pink-400"
                    },
                    {
                        icon: <SiLeetcode />,
                        href: "https://leetcode.com/u/Shivamupadhyay/",
